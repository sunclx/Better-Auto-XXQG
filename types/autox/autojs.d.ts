...
declare module "global" {
  ...
  type Gesture = [number, number, GesturePoint, GesturePoint] | [
    number,
    GesturePoint,
    GesturePoint,
  ];
  ...
  namespace events {
    ...
    function setKeyInterceptionEnabled(key: Keys, enabled: boolean): void;
  ...
  namespace sensors {
    ...
    function unregister(emitter: SensorEventEmitter): void;
  ...
  interface UiSelector {
    ...
    exists(): boolean;
    waitFor(): void;
    filter(filter: (obj: UiObject) => boolean): UiCollection;
  }
